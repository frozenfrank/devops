...
- Target website
- Classify the attack according to the [OWASP Top Ten](../securityCommunity/securityCommunity.md#the-owasp-top-ten), or provide your own classification if the exploit does not fit those categories.
